...

{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            browser.Size = new System.Drawing.Size(899, 505);
            browser.TabIndex = 0;
            browser.TabStop = false;
            this.splitContainer3.Panel2.Controls.Add(browser);
            this.splitContainer3.Size = new System.Drawing.Size(899, 560);
            this.splitContainer3.SplitterWidth = 5;
            this.splitContainer3.TabIndex = 0;
            browser.DocumentCompleted += Browser_DocumentCompleted;
            //browser.Navigate("file:///E:/invoce.pdf");
            
        }

        private void Browser_DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            using (FileStream pdfFile = new FileStream(DEST, FileMode.Create, System.IO.FileAccess.Write))
            {
                stream.CopyTo(pdfFile);
            }


            browser.Navigate("file:///" + DEST);
        }
